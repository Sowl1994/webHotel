...
<div class="col l7 offset-l3 card" style='margin-top: 50px;'>
	<br>
		...
		<div class="input-field col s12 l11  offset-l1 right-align " id="next-habs">
				...
				<button class="btn waves-effect waves-light red" style='float:left;margin-left:40px;' type="submit" name="action">Cancelar 
                </button>
		        <button class="btn waves-effect waves-light blue-grey" style='margin-right:30px;' type="submit" name="action">Anterior 
