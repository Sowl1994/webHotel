...
<div class='content'>
	...
	<div class="col s12 l3 card" id='big-res-carrito' >
				<h2 class ='big-text-cart'> Entrada </h2>
					<p class='date-cart'>Domingo, 29 de Mayo de 2016<br></p>
					<p class='small-text-cart'> A partir de las 1:00 PM (Estancia de 2 noches)</p>
					<hr class='separador-cart'></hr>
				<h2 class ='big-text-cart'> Salida </h2>
					<p class='date-cart'>Martes, 31 de Mayo de 2016<br></p>
					<p class='small-text-cart'>Hasta las 12:00 PM</p>
	</div>
