 ...
 <div class="menu-lateral">
  ...
  <ul class='padd'>
	...
	$home = true;
		...
		if(isset($_GET['secc']) && $_GET['secc'] != "actividades"){echo "<li><a href='index.php?secc=actividades'>Actividades</a></li>";}else{
			if($home == true){echo "<li><a href='index.php?secc=actividades'>Actividades</a></li>";}
		}
...
<div class="menu-lateral-ofertas">
  	<div class="slider">
		<ul>
			<li><img id='imagenCarr' src="./images/carrousel_wall4.jpg"><div class='Slider-text'><a style='color: black; text-decoration:none;' href="index.php?secc=promo"><h4>OFERTA DOS NOCHES</h4></a><p style='line-height: 1em;'>Disfrute de un 10% de descuento en estancias de un mínimo de dos noches.</p></div></li>
			<li><img id='imagenCarr' src="./images/carrousel_wall2.jpg"><div class='Slider-text'><a style='color: black; text-decoration:none;' href="index.php?secc=promo"><h4>OFERTA 10% DE DESCUENTO</h4></a><p style='line-height: 1em;'>Disfrute de un 10% de descuento con esta tarifa no reembolsable.</p></div></li>
			<li><img id='imagenCarr' src="./images/carrousel_wall5.jpg"><div class='Slider-text'><a style='color: black; text-decoration:none;' href="index.php?secc=promo"><h4>HABITACIÓN DOBLE + ESPECTÁCULO DE FLAMENCO</h4></a><p style='line-height: 1em;'>El Flamenco más puro nacido del corazón del monte Albayzín, vive un recuerdo de vida en la cueva flamenca más bonita de Andalucía</p></div></li>
			<li><img id='imagenCarr' src="./images/carrousel_wall.jpg"><div class='Slider-text'><a style='color: black; text-decoration:none;' href="Promociones/promociones.html"><h4>OFERTA RESERVA ANTICIPADA</h4></a><p style='line-height: 1em;'>Disfruta de un 10% de descuento reservando con 21 días de antelación.</p></div></li>
		</ul>
	</div>
</div>
